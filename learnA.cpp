//
// Created by allenhsu on 2018/12/9.
//
#include <queue>
#include <vector>
#include <iostream>
...
public:
    ...
    A_Star()
    {
        cout<<"您正在使用的是A*算法求解迷宫"<<endl;
        cout<<"算法采用广度优先搜索,探测方法优先选择开销最小的状态节点进行拓展"<<endl;
        cout<<"下面,您根据提示输入迷宫的信息"<<endl;
        input();
    }
    //析构函数
    ~A_Star()
